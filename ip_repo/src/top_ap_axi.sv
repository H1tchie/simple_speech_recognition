//////////////////////////////////////////////////////////////////////////////
/*
 Module name:   top_ap_axi
 Authors:       Mateusz Gibas, Kacper Ferdek
 Version:       1.0
 Last modified: 2025
 Description:   Kopia top_ap, w ktorej modul framing zostal zastapiony przez
                framing_axi (sterowany sygnalem sample_valid). Caly dalszy
                lancuch DSP jest niezmieniony - sam siebie taktuje sygnalami
                frame_ready / fft_ready, wiec wolniejsze podawanie probek
                (po jednej na zapis AXI) niczego nie psuje.
 */
//////////////////////////////////////////////////////////////////////////////
module top_ap_axi(
    input  logic clk,
    input  logic rst,
    input  logic [11:0] adc_data,      // teraz: probka z pliku audio (z pamieci)
    input  logic sample_valid,         // strob: nowa probka dostepna
