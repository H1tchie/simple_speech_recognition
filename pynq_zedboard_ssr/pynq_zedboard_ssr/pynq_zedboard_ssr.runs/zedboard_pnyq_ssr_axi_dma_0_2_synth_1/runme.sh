...
HD_PWD='C:/Users/Python/Desktop/sdup/simple_speech_recognition/pynq_zedboard_ssr/pynq_zedboard_ssr.runs/zedboard_pnyq_ssr_axi_dma_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_pnyq_ssr_axi_dma_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_pnyq_ssr_axi_dma_0_2.tcl
