...
# package_ip.tcl
#
# Pakuje rdzen SSR (lancuch DSP + siec neuronowa) jako CUSTOM IP AXI4-Lite
# o nazwie "ssr_axi_lite". Po spakowaniu IP pojawi sie w repozytorium IP
# i bedzie dostepne w Block Designie (IP Catalog).
#
# URUCHOMIENIE (z katalogu glownego repozytorium, gdzie rozpakowano paczke):
#   vivado -mode batch -source ip/package_ip.tcl
# lub w konsoli Tcl Vivado:
#   cd <repo>; source ip/package_ip.tcl
#
# Wynik: katalog  ip_repo/ssr_axi_lite_1.0  (gotowe IP).
#-----------------------------------------------------------------------------
...
# --- Pliki SystemVerilog (nowe + niezmienione moduly projektu) ---
set sv_files [list \
...
# Wymus rozpoznanie interfejsu AXI4-Lite i skojarzonego zegara/resetu
...
puts " Dodaj sciezke ip_repo do IP Catalog w projekcie BD."
puts "==============================================="
