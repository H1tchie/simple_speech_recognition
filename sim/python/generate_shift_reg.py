# -*- coding: utf-8 -*-
"""
Created on Thu Aug 29 18:15:16 2024
...
def generate_hamming_shift_reg(n=128, a0=0.54):
...
def generate_filt_bank_shift_reg(n=128, sample_rate=5000000, nfilt=40):
...
def find_mel_pts(n=128, nfilt=40, sample_rate=5000000):
	low_freq_mel = 0
